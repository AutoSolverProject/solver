...
def assert_on_all_sub_formulae(formula, assertion_function):
    """
    A helper function to check that a certain condition hold on each of the subformulae, including variables and constants.
    ...
    """
    sub_formulae = find_all_sub_formulae(formula, include_variables=True, include_constants=True)
